...
export const Hero: React.FC<HeroProps> = ({ config }) => {
  ...
  return (
    <section id="inicio" className="relative pt-12 pb-20 md:pt-20 md:pb-28 overflow-hidden bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            {/* Status availability badge (steady, no blinking) */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800/80 border border-emerald-500/30 text-xs font-medium text-emerald-300 backdrop-blur-sm">
            ...
            >
              Hola, soy <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-400">{config.name}</span>.
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              <a
                ...
                href="#proyectos"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-slate-800/90 hover:bg-slate-700/90 border border-slate-700 text-slate-200 hover:text-white font-medium text-base transition-all"
              >
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-2 text-xs sm:text-sm text-slate-400">
            ...
            <div className="pt-6 grid grid-cols-3 gap-4 border-t border-slate-800/80 max-w-lg mx-auto lg:mx-0">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="text-xs text-slate-400 mt-0.5">Proyectos Terminados</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl font-extrabold text-cyan-400 font-mono">
                  {config.satisfiedClients}
                </div>
                <div className="text-xs text-slate-400 mt-0.5">Clientes Satisfechos</div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            <div className="relative w-full max-w-md">
              ...
              {/* Decorative Glow */}
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 opacity-30 blur-lg" />
              ...
              <div className="relative bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl space-y-5">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <img
                      ...
                      className="w-20 h-20 rounded-2xl object-cover border-2 border-emerald-500/50 shadow-md bg-slate-800"
                      loading="eager"
                      onError={(e) => {
                ...
                <div className="flex items-center gap-2 pt-1">
                  <span className="px-2.5 py-1 rounded-md text-xs font-mono font-bold bg-orange-500/10 text-orange-400 border border-orange-500/20">
                    &lt;HTML5 /&gt;
                  </span>
                  <span className="px-2.5 py-1 rounded-md text-xs font-mono font-bold bg-sky-500/10 text-sky-400 border border-sky-500/20">
                    #CSS3
                  </span>
                  <span className="px-2.5 py-1 rounded-md text-xs font-mono font-bold bg-yellow-500/10 text-yellow-400 border border-yellow-500/20">
                    JavaScript(ES6+)
                  </span>
                </div>
                ...
                {/* Direct quote */}
                <p className="text-xs text-slate-400 italic bg-slate-800/40 p-3 rounded-lg border border-slate-800">
