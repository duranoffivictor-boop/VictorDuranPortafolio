...
import { 
  ...
  Share2, ExternalLink, Video, Facebook, Instagram, Twitter, Github, Linkedin
} from 'lucide-react';
            ...
            {activeTab === 'content' && (
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                <form onSubmit={handleSaveContent} className="space-y-6 max-w-3xl">
                  ...
                  {/* Social Media & External Profiles Section */}
                    ...
                    <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                      <div>
                        ...
                        <p className="text-[11px] text-slate-400 mt-0.5">
                          Personaliza los enlaces a tus perfiles oficiales de TikTok, Facebook, Instagram, X (Twitter), GitHub y LinkedIn.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800/90 space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          {configForm.tiktokUrl && (
                            <a
                              ...
                              className="text-[11px] text-pink-400 hover:text-pink-300 inline-flex items-center gap-1 font-mono transition-colors"
                            >
                        ...
                        <input
                          ...
                          placeholder="https://tiktok.com/@victorduran.dev"
                          className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-200 focus:outline-none focus:border-pink-500 font-mono transition-colors"
                        />
                      </div>
                      ...
                      <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800/90 space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          {configForm.facebookUrl && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-[11px] text-blue-400 hover:text-blue-300 inline-flex items-center gap-1 font-mono transition-colors"
                            >
                              <span>Probar link</span>
                              <ExternalLink className="w-3 h-3" />
                            </a>
                        ...
                        <input
                          ...
                          placeholder="https://facebook.com/victorduran.dev"
                          className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-200 focus:outline-none focus:border-blue-500 font-mono transition-colors"
                        />
                      </div>
                      ...
                      <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800/90 space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-xs font-semibold text-white flex items-center gap-2">
                            <div className="w-6 h-6 rounded-lg bg-purple-500/10 border border-purple-500/30 flex items-center justify-center text-fuchsia-400">
                          ...
                          {configForm.instagramUrl && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-[11px] text-fuchsia-400 hover:text-fuchsia-300 inline-flex items-center gap-1 font-mono transition-colors"
                            >
                              <span>Probar link</span>
                              <ExternalLink className="w-3 h-3" />
                            </a>
                        ...
                        <input
                          ...
                          placeholder="https://instagram.com/victorduran.dev"
                          className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-200 focus:outline-none focus:border-fuchsia-500 font-mono transition-colors"
                        />
                      </div>
                      ...
                      <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800/90 space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          {configForm.twitterUrl && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-[11px] text-slate-300 hover:text-white inline-flex items-center gap-1 font-mono transition-colors"
                            >
                              <span>Probar link</span>
                              <ExternalLink className="w-3 h-3" />
                            </a>
                        ...
                        <input
                          ...
                          placeholder="https://x.com/victorduran"
                          className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-200 focus:outline-none focus:border-slate-400 font-mono transition-colors"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800/90 space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            {configForm.githubUrl && (
                              <a
                                href={configForm.githubUrl}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-[11px] text-emerald-400 hover:text-emerald-300 inline-flex items-center gap-1 font-mono"
                              >
                                <ExternalLink className="w-3 h-3" />
                              </a>
                            )}
                          ...
                          <input
                            ...
                            placeholder="https://github.com/duranoffivictor-boop"
                        ...
                        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800/90 space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            {configForm.linkedinUrl && (
                              <a
                                href={configForm.linkedinUrl}
                                target="_blank"
                                rel="noopener noreferrer"
                          ...
                          <input
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-200 focus:outline-none focus:border-sky-500 font-mono"
                          />
                        </div>
                      </div>
                    </div>
