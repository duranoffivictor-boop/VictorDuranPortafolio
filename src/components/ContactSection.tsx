...
export const ContactSection: React.FC<ContactSectionProps> = ({ config }) => {
  ...
  return (
    <section id="contacto" className="py-20 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white relative border-t border-slate-200 dark:border-slate-800 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-emerald-900/40 dark:via-slate-950 dark:to-slate-950 border border-emerald-300 dark:border-emerald-500/40 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
              <div className="w-12 h-12 rounded-xl bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
                <MessageCircle className="w-7 h-7 fill-emerald-500/20" />
              </div>
              ...
              <div className="p-4 rounded-xl bg-white dark:bg-slate-900/90 border border-emerald-200 dark:border-slate-800 space-y-1 shadow-xs">
                <span className="text-xs font-mono text-slate-500 dark:text-slate-400 uppercase">Número telefónico</span>
            ...
            {/* Other contact info */}
            <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 space-y-4 text-xs sm:text-sm shadow-xs">
              <div className="flex items-center gap-3 text-slate-700 dark:text-slate-300">
                <div className="p-2.5 rounded-lg bg-slate-100 dark:bg-slate-900 text-emerald-600 dark:text-emerald-400">
                  <Mail className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-slate-500 dark:text-slate-400 block text-[11px]">Correo Electrónico</span>
                  <a href={`mailto:${config.email}`} className="text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 font-medium">
                    {config.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 text-slate-700 dark:text-slate-300">
                ...
                <div>
                  <span className="text-slate-500 dark:text-slate-400 block text-[11px]">Ubicación & Disponibilidad</span>
                  <span className="text-slate-900 dark:text-white font-medium">{config.location}</span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-8 shadow-xs">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-emerald-500 transition-colors"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-emerald-500 transition-colors resize-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full inline-flex items-center justify-center gap-2 py-3 px-6 rounded-xl bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white font-semibold text-sm border border-slate-800 dark:border-slate-700 shadow-sm transition-all disabled:opacity-50"
                >
